...
export class CreateDb1728903100360 implements MigrationInterface {
    name = 'CreateDb1728903100360'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cars" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "photo" text, "title" text NOT NULL, "description" text NOT NULL, "color" text NOT NULL, "start_price" integer NOT NULL, "update_price" integer NOT NULL DEFAULT '0', "currency" text NOT NULL DEFAULT 'UAH', "year" integer NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "brand_id" uuid, "model_id" uuid, "city_id" uuid, "user_id" uuid NOT NULL, CONSTRAINT "PK_fc218aa84e79b477d55322271b6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "content" text NOT NULL, "is_read" boolean NOT NULL DEFAULT false, "to_user_id" uuid NOT NULL, "from_user_id" uuid NOT NULL, CONSTRAINT "PK_18325f38ae6de43878487eff986" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created" TIMESTAMP NOT NULL DEFAULT now(), "updated" TIMESTAMP NOT NULL DEFAULT now(), "image" text, "name" text NOT NULL, "phone" text NOT NULL, "email" text NOT NULL, "password" text NOT NULL, "gender" text NOT NULL DEFAULT 'male', "role" text NOT NULL DEFAULT 'buyer', "account" text NOT NULL DEFAULT 'basic', "balance" double precision NOT NULL DEFAULT '0', "status" boolean NOT NULL DEFAULT false, CONSTRAINT "UQ_a000cca60bcf04454e727699490" UNIQUE ("phone"), CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
